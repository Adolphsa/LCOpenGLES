...
LCImage::LCImage():m_width(0),m_height(0),m_type(0),m_pImgData(NULL)
{
...
void LCImage::ReadFromFile(U8_t* fileName)
{
    int			type = 0;
    int			width = 0;
    int			height = 0;
...
void LCImage::ReadFromBuffer(U8_t* dataBuff,int length)
{
    int			type = 0;
    int			width = 0;
    int			height = 0;
...
int LCImage::GetWidth() const
{
    return m_width;
}

int LCImage::GetHeight() const
{
    return m_height;
}

int LCImage::GetType() const
{
    return m_type;
}

U8_t* LCImage::GetData() const
{
    return m_pImgData;
}